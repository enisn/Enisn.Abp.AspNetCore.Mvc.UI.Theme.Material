...
namespace Enisn.Abp.AspNetCore.Mvc.UI.Theme.Material.Themes.Material.Components.Toolbar
{
    public class MainNavbarToolbarViewComponent : AbpViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Themes/Material/Components/Toolbar/Default.cshtml", toolbar);
        }
    }
}
