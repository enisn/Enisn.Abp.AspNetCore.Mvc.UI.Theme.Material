...
{
    public class MaterialInputTagHelperService : AbpTagHelperService<MaterialInputTagHelper>
    {
        private readonly IHtmlGenerator _generator;
        private readonly HtmlEncoder _encoder;
        private readonly IAbpTagHelperLocalizer _tagHelperLocalizer;

        public MaterialInputTagHelperService(IHtmlGenerator generator, HtmlEncoder encoder, IAbpTagHelperLocalizer tagHelperLocalizer)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            else
            {
                ...
                output.Attributes.AddClass(isCheckBox ? "custom-checkbox" : "form-outline mb-4");
        ...
        protected virtual string GetContent(TagHelperContext context, TagHelperOutput output, string label, string inputHtml, string validation, string infoHtml, bool isCheckbox)
        {
            ...
            var innerContent = inputHtml + label;
